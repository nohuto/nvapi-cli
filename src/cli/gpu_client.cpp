...
namespace nvcli
{
    ...
    int CmdGpuOcScanner(int argc, char **argv)
    {
        ...
        {
            return CmdGpuOcScannerStart(argc - 1, argv + 1);
        }
        if (std::strcmp(argv[0], "stop") == 0)
        {
            return CmdGpuOcScannerStop(argc - 1, argv + 1);
        }
        if (std::strcmp(argv[0], "revert") == 0)
        {
            return CmdGpuOcScannerRevert(argc - 1, argv + 1);
        }
