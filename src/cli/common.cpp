...
namespace nvcli
{
    ...
    namespace
    {
        ...
        void PrintUsageGpu()
        {
            ...
            std::printf("  %s gpu vf inject [--index N] [--flags HEX] [--clk-domain ID --clk-khz N]\n", kToolName);
            std::printf("     [--volt-domain logic|sram|msvdd|ID --volt-rail N --volt-uv N --volt-min-uv N]\n");
            ...
            std::printf("  %s gpu vfe-var set [--index N] --var N --override-type none|value|offset|scale\n", kToolName);
            std::printf("     [--override-value F] [--temp-hyst-pos C] [--temp-hyst-neg C]\n");
            ...
            std::printf("  %s gpu perf-limits set [--index N] --limit-id ID --type disabled|pstate|freq|vpstate [--pstate P0] [--point nominal|min|max|mid]\n", kToolName);
            std::printf("     [--freq-khz N --domain ID] [--vpstate N]\n");
        ...
        void PrintUsageDisplay()
        {
            ...
            std::printf("  %s display custom try --id HEX --width W --height H --refresh R [--depth BPP]\n", kToolName);
            std::printf("     [--type auto|cvt|cvt-rb|gtf|dmt|dmt-rb|eia861|analog-tv|nv-predefined] [--interlaced 0|1] [--hw-only 0|1]\n");
            std::printf("     [--cea-id N] [--tv-format N] [--psf-id N]\n");
            ...
            std::printf("  %s display bpc set --id HEX [--bpc N] [--dither 0|1] [--force-link 0|1] [--force-rg-div 0|1]\n", kToolName);
            ...
            std::printf("     [--os-hdr default|on|off]\n");
        ...
        void PrintUsageGsync()
        {
            ...
            std::printf("  %s gsync control set --index N [--polarity rising|falling|both] [--video-mode none|ttl|ntsc|hdtv|composite]\n", kToolName);
            std::printf("     [--interval N] [--source vsync|housesync] [--interlace 0|1] [--sync-source-output 0|1]\n");
            std::printf("\n");
        }
        ...
        void PrintUsageVideo()
        {
            ...
            std::printf("     [--color-temp N] [--ygamma N] [--rgamma N] [--ggamma N] [--bgamma N] [--override|--use-app]\n");
            std::printf("\n");
        }
        ...
        void PrintUsageHdmi()
        {
            ...
            std::printf("  %s hdmi stereo modes --id HEX [--start N] [--count N] [--pass-through]\n", kToolName);
            std::printf("     [--width W --height H --refresh R]\n");
        ...
        void PrintUsageDp()
        {
            ...
            std::printf("     [--format FORMAT] [--range RANGE] [--colorimetry MODE] [--bpc BPC] [--hpd 0|1] [--defer 0|1]\n");
            std::printf("     [--chroma-lpf-off 0|1] [--dither-off 0|1] [--test-link-train 0|1] [--test-color-change 0|1]\n");
