...
nvapi-cli display custom try --width W --height H --refresh R [--depth BPP]
   [--type auto|cvt|cvt-rb|gtf|dmt|dmt-rb|cea|analog-tv|nv-predefined] [--interlaced 0|1] [--hw-only 0|1]
...
nvapi-cli display monitor-caps [--type generic|vsdb|vcdb|all]
...
nvapi-cli display scaling-override set [--preferred MODE] [--force-override]
   [--gpu-full 0|1] [--gpu-aspect 0|1] [--monitor 0|1] [--center 0|1] [--gpu-aspect-closest 0|1]
   [--gpu-center-closest 0|1] [--gpu-integer 0|1]
...
--type auto|cvt|cvt-rb|gtf|dmt|dmt-rb|cea|analog-tv|nv-predefined // NV_TIMING_OVERRIDE
--interlaced 0|1 // set NV_TIMING_FLAG::isInterlaced
--hw-only 0|1 // request hardware modeset only (no OS update)
--cea-id N // required for type cea (EIA/CEA 861 ID)
...
```c
--type generic|vsdb|vcdb|all // NV_MONITOR_CAPS_TYPE (all queries all three)
```
...
--force-override // replace caps with a single preferred bit
--gpu-full 0|1 // NV_SCALING_GPU_SCALING_TO_NATIVE
--gpu-aspect 0|1 // NV_SCALING_GPU_SCALING_TO_ASPECT_SCANOUT_TO_NATIVE
--monitor 0|1 // NV_SCALING_GPU_SCALING_TO_CLOSEST
--center 0|1 // NV_SCALING_GPU_SCANOUT_TO_NATIVE
--gpu-aspect-closest 0|1 // NV_SCALING_GPU_SCALING_TO_ASPECT_SCANOUT_TO_CLOSEST
--gpu-center-closest 0|1 // NV_SCALING_GPU_SCANOUT_TO_CLOSEST
--gpu-integer 0|1 // NV_SCALING_GPU_INTEGER_ASPECT_SCALING (v2 only)
